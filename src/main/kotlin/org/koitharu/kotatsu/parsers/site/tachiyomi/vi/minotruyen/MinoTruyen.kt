package org.koitharu.kotatsu.parsers.site.tachiyomi.vi.minotruyen
...
@TachiyomiSource("MINOTRUYEN_MANGA", "MinoTruyen Manga", "vi")
class MinoTruyenManga : MinoTruyen("MinoTruyen Manga", "manga") // Alternatives to SourceFactory

@TachiyomiSource("MINOTRUYEN_COMICS", "MinoTruyen Comics", "vi")
class MinoTruyenComics : MinoTruyen("MinoTruyen Comics", "comics") // Alternatives to SourceFactory

@TachiyomiSource("MINOTRUYEN_HENTAI", "MinoTruyen Hentai", "vi")
class MinoTruyenHentai : MinoTruyen("MinoTruyen Hentai", "hentai") // Alternatives to SourceFactory

open class MinoTruyen(
