package org.koitharu.kotatsu.parsers.site.tachiyomi.en.atsumaru
...
@TachiyomiSource("ATSUMARU", "Atsumaru", "en")
class Atsumaru : HttpSource(), ConfigurableSource {
    ...
    override fun setupPreferenceScreen(screen: PreferenceScreen) {
        SwitchPreferenceCompat(screen.context).apply {
            key = PREF_SHOW_18
            title = "Automatically unlock the chapter"
            summary = "May cause slowdowns or crashes; consider this before use."
